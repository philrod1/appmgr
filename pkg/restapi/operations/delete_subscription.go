...
type DeleteSubscriptionHandlerFunc func(DeleteSubscriptionParams) middleware.Responder

// Handle executing the request and returning a response
func (fn DeleteSubscriptionHandlerFunc) Handle(params DeleteSubscriptionParams) middleware.Responder {
	return fn(params)
}
...
type DeleteSubscriptionHandler interface {
	Handle(DeleteSubscriptionParams) middleware.Responder
}
...
/*DeleteSubscription swagger:route DELETE /subscriptions/{subscriptionId} xapp subscriptions deleteSubscription
